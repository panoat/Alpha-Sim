...
#CN#		$app_($contador_nodos) attach_data_generator $gen_($contador_nodos)
		...
		set val(start)	0.0
		set val(stop)	[expr $val(start) + 50.0]
    ...
    set namtraceFile [open trace.nam w]  
...
#-------------------------------------------------------------------------------------------
		...
		set val(data_generator) "[create_data_generator {TemperatureDataGenerator} {7.0} {programmed} {25.0} {5.0} {30.0}]"
		...
		proc finish {} {
		    global ns_ traceFile namtraceFile tempoInicio val
