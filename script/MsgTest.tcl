...
#-------------------------------------------------------------------------------------------
		...
		set val(data_generator) "[create_data_generator {CarbonMonoxideDataGenerator} {5.0} {on demand} {25.0} {5.0} {30.0}]"
	
		for { set common_node_i 0 } { $common_node_i < 5 } { incr common_node_i } {
